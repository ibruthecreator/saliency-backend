...
image_dir = './temp_data/temp_images/'
prediction_dir = './temp_data/temp_results/'
model_dir = './saved_models/basnet_bsi/basnet.pth'


# @filename - name of the file to run the prediction on
# @filename - should be a file in the image_dir path as referenced above
